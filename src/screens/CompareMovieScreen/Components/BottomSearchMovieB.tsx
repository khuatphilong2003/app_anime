...
interface DataProps {
  visible: boolean;
  handleChangeVisibleB: (stt: boolean) => void;
  handleChangeMovieB: (item: IMovie) => void;
}

const BottomSearchMovieB: React.FC<DataProps> = ({
  visible,
  handleChangeVisibleB,
  handleChangeMovieB,
}) => {
...
export default BottomSearchMovieB;
